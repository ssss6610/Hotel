...
namespace WindowsFormsApp1 {
    ...
    public partial class HotelDataSet : global::System.Data.DataSet {
        ...
        public partial class clientsDataTable : global::System.Data.TypedTableBase<clientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public clientsRow AddclientsRow(int id, string first_name, string last_name, string phone, string country) {
...
namespace WindowsFormsApp1.HotelDataSetTableAdapters {
    ...
    public partial class clientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clients] ([id], [first_name], [last_name], [phone], [country])" +
                " VALUES (@id, @first_name, @last_name, @phone, @country);\r\nSELECT id, first_name" +
                ", last_name, phone, country FROM clients WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clients] SET [id] = @id, [first_name] = @first_name, [last_name] = @last_name, [phone] = @phone, [country] = @country WHERE (([id] = @Original_id) AND ((@IsNull_first_name = 1 AND [first_name] IS NULL) OR ([first_name] = @Original_first_name)) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)));
SELECT id, first_name, last_name, phone, country FROM clients WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, first_name, last_name, phone, country FROM dbo.clients";
        ...
        public virtual int Delete(int Original_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_country) {
        ...
        public virtual int Insert(int id, string first_name, string last_name, string phone, string country) {
        ...
        public virtual int Update(int id, string first_name, string last_name, string phone, string country, int Original_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_country) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string phone, string country, int Original_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_country) {
            return this.Update(Original_id, first_name, last_name, phone, country, Original_id, Original_first_name, Original_last_name, Original_phone, Original_country);
        }
    }
